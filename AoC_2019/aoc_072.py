# -*- coding: utf-8 -*-
"""
Created on Thu Dec  7 09:08:29 2019
...
#inpt as the output from prior amp (starting with 0), newstart as the phase setting
inpt = 6
phase = 0

def ampsignal(noun, verb, integerinput, phase):
    intlist = [3,26,1001,26,-4,26,3,27,1002,27,2,27,1,27,26,27,4,27,1001,28,-1,28,1005,28,6,99,0,0,5]
    #intlist = [3,8,1001,8,10,8,105,1,0,0,21,38,47,64,85,106,187,268,349,430,99999,3,9,1002,9,4,9,1001,9,4,9,1002,9,4,9,4,9,99,3,9,1002,9,4,9,4,9,99,3,9,1001,9,3,9,102,5,9,9,1001,9,5,9,4,9,99,3,9,101,3,9,9,102,5,9,9,1001,9,4,9,102,4,9,9,4,9,99,3,9,1002,9,3,9,101,2,9,9,102,4,9,9,101,2,9,9,4,9,99,3,9,1002,9,2,9,4,9,3,9,102,2,9,9,4,9,3,9,1001,9,2,9,4,9,3,9,1001,9,1,9,4,9,3,9,101,1,9,9,4,9,3,9,102,2,9,9,4,9,3,9,101,2,9,9,4,9,3,9,102,2,9,9,4,9,3,9,1002,9,2,9,4,9,3,9,1002,9,2,9,4,9,99,3,9,102,2,9,9,4,9,3,9,1002,9,2,9,4,9,3,9,1001,9,1,9,4,9,3,9,1002,9,2,9,4,9,3,9,101,1,9,9,4,9,3,9,1002,9,2,9,4,9,3,9,1001,9,2,9,4,9,3,9,1001,9,1,9,4,9,3,9,101,2,9,9,4,9,3,9,101,1,9,9,4,9,99,3,9,102,2,9,9,4,9,3,9,102,2,9,9,4,9,3,9,1001,9,1,9,4,9,3,9,1002,9,2,9,4,9,3,9,102,2,9,9,4,9,3,9,1002,9,2,9,4,9,3,9,101,1,9,9,4,9,3,9,101,1,9,9,4,9,3,9,101,1,9,9,4,9,3,9,1002,9,2,9,4,9,99,3,9,1002,9,2,9,4,9,3,9,102,2,9,9,4,9,3,9,101,1,9,9,4,9,3,9,1001,9,1,9,4,9,3,9,1002,9,2,9,4,9,3,9,102,2,9,9,4,9,3,9,102,2,9,9,4,9,3,9,101,2,9,9,4,9,3,9,102,2,9,9,4,9,3,9,1002,9,2,9,4,9,99,3,9,1002,9,2,9,4,9,3,9,101,1,9,9,4,9,3,9,102,2,9,9,4,9,3,9,1001,9,2,9,4,9,3,9,1002,9,2,9,4,9,3,9,1002,9,2,9,4,9,3,9,1001,9,1,9,4,9,3,9,1002,9,2,9,4,9,3,9,1001,9,1,9,4,9,3,9,102,2,9,9,4,9,99]
...
def thrustsignala(apmphases,amp):
    #print(apmphases)
    #print(len(apmphases))
    #print()
    amp = amp
    #print(amp)
    for i in range((len(apmphases)-1)):
        #print(i+1)
        #print(apmphases[(i+1)])
        amp = ampsignal(noun,verb,amp,apmphases[(i+1)])[0]
        #print(amp)
        #print()
    return amp
        
def thrustsignalb(apmphases,amp):
    #print(apmphases)
    #print(len(apmphases))
    #print()
    amp = amp
...
print("looking in permutations of: " + str(permsa[0]))
allthrusts_a = {}
allthrusts_b = {}
for i in range(len(permsa)):
    amp = ampsignal(noun,verb,inpt,permsa[i][0])[0]
    thisthrusta = thrustsignala(permsa[i], amp)
    for j in range(len(permsb)):
        thisthrustb = thrustsignalb(permsb[j], thisthrusta)
        allthrusts_b[j] = thisthrustb
        allthrusts_a[i,j] = thisthrustb
    print(thisthrusta)
    #print(str(permsa[i]) + ": " + str(thisthrust))


#print(allthrusts)
    
print(max(allthrusts_a.items(), key=operator.itemgetter(1))[1])

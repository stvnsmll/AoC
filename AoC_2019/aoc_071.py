...
def thrustsignal(apmphases):
    #print(apmphases)
    #print(len(apmphases))
    #print()
    amp = ampsignal(noun,verb,inpt,apmphases[0])[0]
    #print(amp)
...
for i in range(len(permsa)):
    thisthrust = thrustsignal(permsa[i])
    allthrusts[i] = thisthrust
    #print(str(permsa[i]) + ": " + str(thisthrust))


#print(allthrusts)
    
print(max(allthrusts.items(), key=operator.itemgetter(1))[1])

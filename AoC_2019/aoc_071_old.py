...
def ampsignal(noun, verb, integerinput, phase):
    intlist = [3,31,3,32,1002,32,10,32,1001,31,-2,31,1007,31,0,33,1002,33,7,33,1,33,31,31,1,32,31,31,4,31,99,0,0,0]
...
def thrustsignal(apmphases):
    for i in range(len(apmphases)):
        print(i)
        print(apmphases)
        print(len(apmphases))
        print(apmphases[i])
        amp1 = ampsignal(noun,verb,0,apmphases[i])[0]
        print(amp1)
        print(apmphases[1-i])
        amp2 = ampsignal(noun,verb,amp1,apmphases[1])[0]
        print(amp2)
        print()
    return amp2
        
        
print("specific permutation to get thrust signal is: " + str(perms[0]))
print("\n\n")
print(thrustsignal(perms[0]))
...
#print("Thruster Signal for phase " + str(phase) + " is: " + str(ampsignal(noun,verb,inpt,phase)[0]))

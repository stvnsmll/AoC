...
def address0finder(noun, verb, integerinput):
    ...
    while True:
        ...
        #validity checking
        if not ((1 <= opcode <= 4) or (opcode == 99)):
        ...
        if opcode == 1:
            ...
            print(str(newstart) + "[" + str(raw_opcode) + "," + str(num1) + "," + str(num2) + "]--> position " + str(overridepos) + " set to: " + str(newval))

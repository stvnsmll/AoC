...
class TestBasic(unittest.TestCase):
    """ Test Cases to skip:
        ...
        def test_AoC2018_04_1_a(self):
            [year, day, part, example, solution_type] = [2018, 4, 1, "a", "int"]#works with int or str
            [solution, answer] = solve_with_test(year, day, part, example, solution_type)
            self.assertEqual(solution, answer)
        
        def test_AoC2018_04_2_a(self):
    ...
    def test_AoC2018_07_1_a(self):
        [year, day, part, example, solution_type] = [2018, 7, 1, "a", "str"]#works with int or str
        [solution, answer] = solve_with_test(year, day, part, example, solution_type)
        self.assertEqual(solution, answer)
    
    def test_AoC2018_07_2_a(self):
        [year, day, part, example, solution_type] = [2018, 7, 2, "a", "int"]#works with int or str
        [solution, answer] = solve_with_test(year, day, part, example, solution_type)
        self.assertEqual(solution, answer)
